...
\begin{description}
	...
	\item[Irradiance] Fflux at a specific point
	\item[Radiant intensity] Flux in some direction (sr or steradian is a unit for the solid angle --- surface on a unit sphere, whole sphere has $4*\Pi$ steradians)
	\item[Radiance] Spatial and directional flux
\end{description}

The relationship between these quantities is described by the \emph{spectral efficiency function}. Basically, it states how efficiently a human eye reacts to the specific wavelengths of light. This function is shown in \ref{fig:lum}.
